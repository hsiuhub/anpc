...
#define CTRL_IA_PI_KP_LIGHT     ((float32_t)4.0)
#define CTRL_IA_PI_KP_HEAVY     ((float32_t)4.0)
...
#define CTRL_IB_PI_KP_LIGHT     ((float32_t)4.0)
#define CTRL_IB_PI_KP_HEAVY     ((float32_t)4.0)
...
#define CTRL_IC_PI_KP_LIGHT     ((float32_t)4.0)
#define CTRL_IC_PI_KP_HEAVY     ((float32_t)4.0)
